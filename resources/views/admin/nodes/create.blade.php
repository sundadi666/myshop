        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal" action="/admin/nodes" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="desc" class="form-control" placeholder="权限名称">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="cname" class="form-control" placeholder="控制器名称">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">方法名称</label>
                    <div class="col-md-9">
                        <input type="text" name="aname" class="form-control" placeholder="方法名称">
                    </div>
                </div>      
                <div class="form-group">

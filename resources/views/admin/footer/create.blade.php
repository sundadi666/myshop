...
<div class="col-md-6 ui-sortable">
    ...
    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
            <form class="form-horizontal" action="/admin/footer" method="post">
            	{{ csrf_field() }}
                <div class="form-group">
                    <label class="col-md-3 control-label">版权</label>
                    <div class="col-md-9">
                        <input type="text" name="copy" class="form-control" placeholder="版权">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="filing" class="form-control" placeholder="备案号">
                    </div>
                </div>
